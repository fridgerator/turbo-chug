...
public class Futurama extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.fridgerator.TurboChug.kafka.Futurama.Builder newBuilder() {
    return new com.fridgerator.TurboChug.kafka.Futurama.Builder();
  }
   ...
   * @return A new Futurama RecordBuilder
   */
  public static com.fridgerator.TurboChug.kafka.Futurama.Builder newBuilder(com.fridgerator.TurboChug.kafka.Futurama.Builder other) {
    if (other == null) {
      return new com.fridgerator.TurboChug.kafka.Futurama.Builder();
    } else {
      return new com.fridgerator.TurboChug.kafka.Futurama.Builder(other);
    }
  }
   ...
   * @return A new Futurama RecordBuilder
   */
  public static com.fridgerator.TurboChug.kafka.Futurama.Builder newBuilder(com.fridgerator.TurboChug.kafka.Futurama other) {
    if (other == null) {
      return new com.fridgerator.TurboChug.kafka.Futurama.Builder();
    } else {
      return new com.fridgerator.TurboChug.kafka.Futurama.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Futurama>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.fridgerator.TurboChug.kafka.Futurama.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.fridgerator.TurboChug.kafka.Futurama other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.character)) {
        this.character = data().deepCopy(fields()[0].schema(), other.character);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder setCharacter(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder clearCharacter() {
      character = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder setHermesCatchPhrase(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder clearHermesCatchPhrase() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder setLocation(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder clearLocation() {
      location = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder setQuote(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder clearQuote() {
      quote = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder setId(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.fridgerator.TurboChug.kafka.Futurama.Builder clearId() {
